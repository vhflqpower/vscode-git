           ...
           <div class="table-responsive">
				...
				<? if($board['bo_use_category']){ ?>
					...
					<div class="input-group date" style="width:200px;">
						<input type="text" name="wr_1"  value="<?=$write['wr_1']?>"  class="form-control" style="width:200px;"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
					 </div></td>
					</tr>
					<tr>
