...
<!-- json & xml parser -->
<script type="text/javascript" language="javascript" src="<?=$app['path']?>/board/multiuploader/common/json2.js"></script>
<script type="text/javascript" language="javascript" src="<?=$app['path']?>/board/multiuploader/common/xml2json.js"></script>
<!-- json & xml parser -->

<!-- jQuery -->
<script type="text/javascript" language="javascript" src="<?=$app['path']?>/board/multiuploader/common/jquery-2.0.2.min.js"></script>
<!-- jQuery -->

<!-- SWFUpload -->
<script type="text/javascript" src="<?=$app['path']?>/board/multiuploader/SWFUpload/swfupload.js"></script>
<script type="text/javascript" src="<?=$app['path']?>/board/multiuploader/SWFUpload/swfupload.queue.js"></script>
<!-- SWFUpload -->

<!-- Sayku Library -->
<link rel="stylesheet" type="text/css" charset="UTF-8" media="all" href="<?=$app['path']?>/board/multiuploader/syaku.file.css" />
<script type="text/javascript" src="<?=$app['path']?>/board/multiuploader/syaku.file.js"></script>
<script type="text/javascript" src="<?=$app['path']?>/board/multiuploader/syaku.file.handlers.js"></script>
<!-- Sayku Library -->

<!-- SmartEditor2 -->
<script type="text/javascript" src="<?=$app['path']?>/board/SmartEditor2_3_10/js/HuskyEZCreator.js" charset="utf-8"></script>
<script type="text/javascript" src="<?=$app['path']?>/board/multiuploader/syaku.smarteditor.handlers.js"></script>
<script>
/** SmartEditor */
...
jQuery(function() {
 ...
 //   sSkinURI: "<?=$app['path']?>/SmartEditor2_3_10/SmartEditor2Skin.html",	
    htParams : {
      bUseToolbar : true,				
    ...
    fOnAppLoad : function(){
      objEditor[1] = objEditor.getById['wr_content'];
    },
			...
			<form name="frm" method="post" action="./write_update.php" onSubmit="return saveSubmit(f)" enctype="multipart/form-data" >
				...
				<? if($board['bo_use_category']){ ?>
					...
					<tr>
						...
						<td colspan="2"><textarea id="wr_content" name="wr_content" class="ckeditor" rows="10" cols="80"><?=$write['wr_content']?></textarea></td>
