				...
				<!-- json & xml parser -->
		<script type="text/javascript" language="javascript" src="<?php echo G5_URL ?>/board/multiuploader/common/json2.js"></script>
		<script type="text/javascript" language="javascript" src="<?php echo G5_URL ?>/board/multiuploader/common/xml2json.js"></script>
		<!-- json & xml parser -->

		<!-- jQuery -->
		<script type="text/javascript" language="javascript" src="<?php echo G5_URL ?>/board/multiuploader/common/jquery-2.0.2.min.js"></script>
		<!-- jQuery -->

		<!-- SWFUpload -->
		<script type="text/javascript" src="<?php echo G5_URL ?>/board/multiuploader/SWFUpload/swfupload.js"></script>
		<script type="text/javascript" src="<?php echo G5_URL ?>/board/multiuploader/SWFUpload/swfupload.queue.js"></script>
		<!-- SWFUpload -->

		<!-- Sayku Library -->
		<link rel="stylesheet" type="text/css" charset="UTF-8" media="all" href="<?php echo G5_URL ?>/board/multiuploader/syaku.file.css" />
		<script type="text/javascript" src="<?php echo G5_URL ?>/board/multiuploader/syaku.file.js"></script>
		<script type="text/javascript" src="<?php echo G5_URL ?>/board/multiuploader/syaku.file.handlers.js"></script>
		<!-- Sayku Library -->
		...
		<script type="text/javascript" src="<?php echo G5_URL ?>/board/multiuploader/syaku.ckeditor.handlers.js"></script>
		<script>
		// ckeditor  초기설정
           ...
           <div class="table-responsive">
				...
				<? if($board['bo_use_category']){ ?>
					...
					<tr>
						...
						<td colspan="2"><textarea id="wr_content" name="wr_content"  rows="10" cols="80"><?=$write['wr_content']?></textarea></td>
