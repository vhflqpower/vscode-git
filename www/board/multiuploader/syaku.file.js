  ...
  jQuery.syakuFileUpload = {
    ...
    swfupload : function(options) {
      ...
      var settings = {
        ...
        upload_url: "./multiuploader/syaku.upload.php",
        delete_url : "./multiuploader/syaku.delete.php" , 
        file_folder : "",// "/files"
        post_params: {
        ...
        */
        ...
        button_image_url : "./multiuploader/syaku.file.png",
        button_text : "첨부파일",
        ...
        // Flash Settings
        flash_url : "./multiuploader/SWFUpload/swfupload.swf",
