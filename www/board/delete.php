...
if ($count_write > 0 || $count_comment > 0)
    sql_query(" update {$g5['board_table']} set bo_count_write = bo_count_write - '$count_write',
...
// ,
        ...
        // 업로드된 파일이 있다면 파일삭제
        $sql2 = " select * from {$g5['board_file_table']} where bo_table = '$bo_table' and wr_id = '{$write['wr_id']}' ";
...
//echo " delete from $write_table where wr_parent = '{$write['wr_id']}' ";exit;

	goto_url('./list.php?bo_table='.$bo_table.'&amp;page='.$page.$qstr);
