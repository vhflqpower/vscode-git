...
define('G5_MYSQL_USER', 'psjmta');
define('G5_MYSQL_PASSWORD', 'psj2018*');
define('G5_MYSQL_DB', 'psjmta');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');
define('PSJ_TABLE_PREFIX', 'psj_');
...
$g5['board_table'] = 'psj_board_config'; //  psj 게시판 설정 테이블
...
$g5['member_table'] = PSJ_TABLE_PREFIX.'member'; // 회원 테이블
