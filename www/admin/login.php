...
//include_once("$app_path/lib/common.php");
...
<head>
    ...
    <meta name="msapplication-TileImage" content="/assets/login/img/metis-tile.png" />
    
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/assets/login/lib/bootstrap/css/bootstrap.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/assets/login/lib/font-awesome/css/font-awesome.css">
    
    <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="/assets/login/css/main.css">
    
    <!-- metisMenu stylesheet -->
    <link rel="stylesheet" href="/assets/login/lib/metismenu/metisMenu.css">
    
    <!-- animate.css stylesheet -->
    <link rel="stylesheet" href="/assets/login/lib/animate.css/animate.css">
...
<body class="login">
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            <form name="frm1" method="post" action="./login_check.php">
...
*/
    ...
    <!--jQuery -->
    <script src="/assets/login/lib/jquery/jquery.js"></script>

    <!--Bootstrap -->
    <script src="/assets/login/lib/bootstrap/js/bootstrap.js"></script>
