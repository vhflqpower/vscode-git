 ...
 <div class="container-fluid">
	...
	?>
       ...
       <div class="main"><!-- col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main -->
          ...
          <h2 class="sub-header">마이 메이커플랜</h2>
				...
				<input type="hidden" name="tab_id" id="tab_id" value="<?=$tab_id?>">
			      ...
			      <div class="panel-body">
					<div class="tab-content">
						...
						<div  id="contentArea">
							<div class="row">
							  <div class="col-sm-6 col-md-3" id="1">
								<div class="thumbnail">
								
								 
									<img class="syaku_1" src="http://mta.master36.com/data/board/img/info/1028197075_d72a4790_EC849DEC9AB0EBB098EBAA85ED95A8.jpg"  />
								  <div class="caption">
							  ...
							  <div class="col-sm-6 col-md-3" id="2">
								<div class="thumbnail">
									<img class="syaku_1" src="http://mta.master36.com/data/board/img/info/1028197075_d72a4790_EC849DEC9AB0EBB098EBAA85ED95A8.jpg"  />
								  <div class="caption">
									<h3>Thumbnail label</h3>
							  ...
							  <div class="col-sm-6 col-md-3" id="3">
								<div class="thumbnail">
									<img class="syaku_1" src="http://mta.master36.com/data/board/img/info/1028197075_d72a4790_EC849DEC9AB0EBB098EBAA85ED95A8.jpg"  />
								  <div class="caption">
									<h3>Thumbnail label</h3>
							  ...
							  <div class="col-sm-6 col-md-3" id="4">
								<div class="thumbnail">
								 <img class="syaku_1" src="http://mta.master36.com/data/board/img/info/1028197075_d72a4790_EC849DEC9AB0EBB098EBAA85ED95A8.jpg"  />
								  <div class="caption">
									<h3>Thumbnail label</h3>
...
$(document).ready(function() {
   ...
   $('#my_maker_plan').attr("class", "list-group-item active");
