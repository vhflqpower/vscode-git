...
?>
 ...
 <div class="container-fluid">
	...
	<? if($bo_table !='bugreport'){ ?>  
          <h3 class="sub-header"><?=$view['wr_subject']?>
		  마이 인포 등록</h3>
          <? }else{ ?>
	...
	<? } ?>
			...
			<form name="frm" method="post" action="./my_board_update.php" onSubmit="return saveSubmit(f)" enctype="multipart/form-data" >
  ...
  <div class="table-responsive" id="openArea" style="display:none;">
		...
		<? } ?>
          ...
          <div class="table-responsive">
				...
				<tbody >
					...
					<td>
						<div class="btn-group" data-toggle="buttons">
						  <button type="button" class="btn btn-default active" style="color:#ff0000;"  id="open_yn_N" value="N" onclick="open_yn_choice(this.value)">비공개</button>
						  <button type="button" class="btn btn-default" style="color:#0000ff;"  id="open_yn_Y" value="Y" onclick="open_yn_choice(this.value)">공개</button>
						</div><input type="hidden" name="wr_open_yn" id="wr_open_yn" value="N">
					<script>
					function  open_yn_choice(val){

						$('#open_yn_Y').attr("class", "btn btn-default");
						$('#open_yn_N').attr("class", "btn btn-default");
						$("#wr_open_yn").val(val);
						if(val=='Y'){
			...
			<div style="float:right">
						...
						<button type="button" class="btn btn-default btn-sm"  onclick="location.href='./my_board.php?part=<?=$part?>&bo_table=<?=$bo_table?>'">
