...
$sql = " select bf_source, bf_file from {$g5['board_file_table']} where bo_table = '$bo_table' and seq = '$seq'";
$file = sql_fetch($sql);
...
if($bo_table=='issu' || $bo_table=='data' || $bo_table=='myfile'){

$filepath = $file_path.'/data/pms/'.$bo_table.'/'.$file['bf_file'];
}else{
$filepath = $file_path.'/data/board/file/'.$bo_table.'/'.$file['bf_file'];
}
