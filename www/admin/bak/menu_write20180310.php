...
?>
 ...
 <div class="container-fluid">
    ...
    <form name="fwrite" id="fwrite" action="./menu_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
			...
			<table  class="table table-bordered table-hover">
				...
				<? if($row['me_code']){ ?>
					<th>MENU CODE</th>
					<td><input type="text" name="me_code" value="<?=$row['me_code']?>" class="form-control" style="width:200px;" READONLY/></td>
					</tr>
				<? }else{ ?>
					<th>MENU CODE</th>
					<td><input type="text" name="me_code" value="<?=$row['me_code']?>"  id="reg_me_table" onblur='reg_mb_cd_check();' class="form-control" style="width:200px;" />
				...
				<? } ?>
					...
					<th>제목</th>
					<td><input type="text" name="me_subject" value="<?=$row['me_subject']?>" class="form-control" style="width:200px;" /></td>
					</tr>
