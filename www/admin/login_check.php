...
if (!trim($mb_id) || !trim($mb_password))
	...
	echo "<script>alert('회원아이디나 패스워드가 공백이면 안됩니다.');history.back();</script>";
...
// 로그인 로그  
	sql_query("INSERT INTO psj_login set lo_ip ='{$_SERVER['REMOTE_ADDR']}', mb_id = '$mb[mb_id]', lo_datetime ='".G5_TIME_YMDHIS."'");
