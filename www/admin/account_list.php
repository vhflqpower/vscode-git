...
?>
			<button type="button" class="btn btn-primary btn-sm" onclick="location.href='./account_write.php?part=account'">
...
function get_account_row(){
	...
	$("#results").load("./ajax/ajax_account_row_data.php",{'search_field':s_field,'search_value':s_value,'co_id':co_id});
        ...
        var obj = $('.pagination').twbsPagination({
			...
			$("#results").load("./ajax/ajax_account_row_data.php", {'page':page});
