<?
	...
	sql_query("update `psj_board_info` set wr_hit = wr_hit+1 where wr_id = '$wr_id' ");
	...
	if($wr_id){
		...
		//	$view['content'] = conv_content($view['wr_content'], $html);
			...
			//$str_content = str_replace("/data/board/img/info","http://mta.master36.com/data/board/img/info",$str_content);
