...
// $position, $item_per_page  
	...
	$results = sql_query("SELECT * FROM psj_menu_config where 1=1 ORDER BY me_sort DESC LIMIT $position, $item_per_page");
...
?>
		 <tr>;
			 <td ><div align=center><font color=blue><?=$row['me_sort']?></a></div></td>;
			 <td><?=$me_code?></td>;
