...
// $position, $item_per_page  
	...
	$results = sql_query("SELECT is_id,is_subject,sdate,wr_name FROM psj_issu where 1=1 and pj_id ='$pj_id' ORDER BY is_id DESC LIMIT $position, $item_per_page");
