...
//	include_once("./dbconfig.php");
	...
	$paginationlink = "/admin/ajax/ajax_board_row_data.php?bo_table=$bo_table&page=";				
...
?>
		 ...
		 <tr>
			...
			<? }else{ ?>
			 ...
			 <td id=item_<?=$row['wr_id']?>><strong><a href="./board_view.php?wr_id=<?=$wr_id?>&part=<?=$part?>&bo_table=<?=$bo_table?>&page=<?=$page?>"><?=$wr_subject?></a></strong>
			<? if($com_cnt > 0){ ?><span class="badge"><?=$com_cnt?></span><? } ?>
			 <?=$list['icon_new']?>
