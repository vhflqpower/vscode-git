<?
	...
	// 페이징용 카운트 
		...
		if($search_value){
			$where = " AND mb_name like '%$search_value%'";
		}

		$item_per_page = 10;
		$sql = "SELECT COUNT(*)as cnt FROM psj_member where 1=1 $where";
...
?>
   <style>
	...
	<form class="navbar-form navbar-left" role="search" id="searchform" method="GET">
	  <div class="form-group">
	  <input type="text" name="mode" value="search">
		<input type="text" id="search_value" name="search_value" class="form-control" placeholder="Search">
	  </div>
	  <button type="submit" id="bt_search" class="btn btn-default">검색하기</button>
	</form>
