...
include_once("./_common.php");
	...
	$grid_pager = 'p'.$grid;
	$grid_div = 'div_'.$grid;
	$ajax_url = './ajax_company_info_data.php';
...
var $grid_div = false; //전역 그리드페이저 변수
 ...
 $grid.jqGrid({
	...
	colNames:['NO','업체ID','업체명','보기'],
	colModel:[
		{name:'co_no',index:'co_no', width:70, align:"center", editable:true,hidden:false, viewable: false, hidedlg:false,formoptions:{ rowpos:1 }},
		{name:'co_id',index:'co_id', width:114,align:"center",editable:true,editoptions:{readonly:false,size:10},formoptions:{ rowpos:2 }},	
		{name:'co_name',index:'co_name', width:140,align:"center",editable:true,editoptions:{readonly:false,size:10},formoptions:{ rowpos:3 }},	
...
/* edittype:'textarea', */
	...
	,gridComplete: function(){
		...
		for(var i=0; i < ids.length;i++){
	 	...
	 	co_id = $grid.jqGrid("getRowData", cl).co_id;	
		var company = $grid.jqGrid("getRowData", cl).co_name;	

			be = "<a href='#' onclick=\"parentsend('"+co_id+"','"+company+"')\"><input style='height:22px;width:40px;' type='button' value='적용' ></a>"; 
