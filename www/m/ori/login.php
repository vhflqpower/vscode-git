...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?=$app[path]?>/assets/lib/bootstrap/css/bootstrap.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?=$app[path]?>/assets/lib/font-awesome/css/font-awesome.css">
    
    <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="<?=$app[path]?>/assets/css/main.css">
    
    <!-- metisMenu stylesheet -->
    <link rel="stylesheet" href="<?=$app[path]?>/assets/lib/metismenu/metisMenu.css">
    
    <!-- animate.css stylesheet -->
    <link rel="stylesheet" href="<?=$app[path]?>/assets/lib/animate.css/animate.css">
  ...
  <script type="text/JavaScript" src="<?=$app[path]?>/js/jquery-1.7.2.min.js"></script>
</head>
